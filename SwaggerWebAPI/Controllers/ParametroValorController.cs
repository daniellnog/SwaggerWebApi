...
{
    public class ParametroValorController : ApiController
    {
        static readonly IParametroValorRepositorio repositorio = new ParametroValorRepositorio();

        /// <summary>
        /// Retorna todos os parametros valores
        /// </summary>
        public IEnumerable<ParametroValor> GetAllParametrosValores()
        {
